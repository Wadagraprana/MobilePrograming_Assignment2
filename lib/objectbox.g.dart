...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 5046726225659504254),
      name: 'Quote',
      lastPropertyId: const obx_int.IdUid(3, 2923669684035921756),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 590914560538923317),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 8415295068963372071),
            name: 'text',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 2923669684035921756),
            name: 'author',
            type: 9,
            flags: 0)
      ],
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(1, 5046726225659504254),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    Quote: obx_int.EntityDefinition<Quote>(
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final object =
              Quote(id: idParam, text: textParam, author: authorParam);
...
class Quote_ {
  /// See [Quote.id].
  static final id = obx.QueryIntegerProperty<Quote>(_entities[0].properties[0]);

  /// See [Quote.text].
  static final text =
      obx.QueryStringProperty<Quote>(_entities[0].properties[1]);
